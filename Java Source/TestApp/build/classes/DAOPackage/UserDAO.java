...
public class UserDAO {
	...
	public void doSaveOrUpdate(UserBean usr) throws SQLException, ClassNotFoundException, InstantiationException {
	...
	//elimina lo UserBean
	public void doDelete(UserBean usr) throws SQLException, ClassNotFoundException, InstantiationException{
		DatabaseConnector connector = new DatabaseConnector();
		connector.startConnection();
	...
	public ArrayList<UserBean> doRetrieveAll() throws SQLException, ClassNotFoundException, InstantiationException{
		DatabaseConnector connector = new DatabaseConnector();
		connector.startConnection();
